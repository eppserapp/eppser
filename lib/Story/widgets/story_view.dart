...
import 'package:eppser/Story/story_view.dart';
...
class StoryViewState extends State<StoryView> with TickerProviderStateMixin {
    ...
    this._playbackSubscription =
      ...
      switch (playbackStatus) {
        ...
        case PlaybackState.next:
          ...
          dataIndex++;
          dataIndx();
          Provider.of<dataIndexProvider>(context, listen: false).set(dataIndex);
          break;
  ...
  void _onComplete() {
    if (widget.onComplete != null) {
      ...
      Provider.of<dataIndexProvider>(context, listen: false).set(0);
      widget.onComplete!();
    }
  ...
  void seenStory() async {
    await FireStoreMethods().seenStory(widget.data![dataIndex].data()['postId'],
  ...
  void dataIndx() {
    if (dataIndex >= widget.storyItems.length || dataIndex < 0) {
      dataIndex == 0;
    }
  }
        ...
        return Expanded(
          child: Container(
            ...
            child: StoryProgressIndicator(
              ...
              indicatorHeight:
                  widget.indicatorHeight == IndicatorHeight.large ? 4 : 3,
              indicatorColor: widget.indicatorColor,
            ),
          ),
        );
